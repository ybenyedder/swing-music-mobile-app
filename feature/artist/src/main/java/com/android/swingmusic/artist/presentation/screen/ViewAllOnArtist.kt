...
fun ViewAllScreenOnArtist(
    ...
    val artistInfoState = artistInfoViewModel.artistInfoState.collectAsStateWithLifecycle()
    val playerUiState = mediaControllerViewModel.playerUiState.collectAsStateWithLifecycle()
