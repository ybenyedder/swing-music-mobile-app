...
import com.android.swingmusic.core.data.dto.FavoriteTracksResponseDto
import com.android.swingmusic.core.data.dto.FoldersAndTracksRequestDto
import com.android.swingmusic.core.data.dto.PlaylistTracksResponseDto
import com.android.swingmusic.core.data.dto.PlaylistsResponseDto
...
interface NetworkApiService {
    ...
    suspend fun getAllPlaylists(
        @Url url: String,
        @Header("Authorization") bearerToken: String,
        @Query("no_images") noImages: Boolean = false,
