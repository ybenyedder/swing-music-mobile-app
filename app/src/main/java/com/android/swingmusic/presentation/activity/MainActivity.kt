    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val bottomNavRoutePrefixes = mapOf(
                ...
                BottomNavItem.Favorites to listOf(FavoritesScreenDestination.route),
                BottomNavItem.Playlists to listOf(PlaylistsScreenDestination.route)
            )
                    ...
                    topBar = {
                        if (showTopBar) {
                            val title = when (route) {
                                ...
                                FavoritesScreenDestination.route -> "Favorites"
                                PlaylistsScreenDestination.route -> "Playlists"
                                        ...
                                        bottomNavItems.forEach { item ->
                                            NavigationBarItem(
                                                ...
                                                colors = NavigationBarItemDefaults.colors(
                                                    ...
                                                    unselectedIconColor = androidx.compose.ui.graphics.Color.White.copy(alpha = 0.8f),
                                                    unselectedTextColor = androidx.compose.ui.graphics.Color.White.copy(alpha = 0.8f),
                                                ),
