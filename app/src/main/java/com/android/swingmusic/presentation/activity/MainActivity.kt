...
import com.android.swingmusic.uicomponent.presentation.component.SwingAppBar
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val playerState = mediaControllerViewModel.playerUiState.collectAsStateWithLifecycle()
            ...
            val bottomNavRoutePrefixes = mapOf(
                ...
                BottomNavItem.Search to listOf(SearchScreenDestination.route),
                BottomNavItem.Library to listOf(PlaylistsScreenDestination.route)
            )
            ...
            val noTopBarRoutes = listOf(
                ...
                PlaylistsScreenDestination.route,
                PlaylistDetailScreenDestination.route,
                SearchScreenDestination.route,
                LyricsScreenDestination.route,
                HistoryScreenDestination.route,
                com.android.swingmusic.home.presentation.destinations.SettingsScreenDestination.route,
            )
                    ...
                    topBar = {
                        if (showTopBar) {
                            val title = when (route) {
                                ...
                                PlaylistsScreenDestination.route -> "Your Library"
                                SearchScreenDestination.route -> "Search"
                                else -> "Swing Music"
                            }
                            SwingAppBar(
                                title = title,
                                    ...
                                    Row(
                                        ...
                                        bottomNavItems.forEach { item ->
                                                ...
                                                colors = NavigationBarItemDefaults.colors(
                                                    ...
                                                    unselectedIconColor = androidx.compose.ui.graphics.Color(0xFFB3B3B3),
                                                    unselectedTextColor = androidx.compose.ui.graphics.Color(0xFFB3B3B3),
                                                ),
                                                selected = isSelected,
                                                ...
                                                label = {
                                                    Text(
                                                        ...
                                                        color = if (isSelected) androidx.compose.ui.graphics.Color.White else androidx.compose.ui.graphics.Color(0xFFB3B3B3)
                                                    )
                                                },
                                                onClick = {
